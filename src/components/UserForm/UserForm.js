    ...
    <div className="flex flex-col shadow-2xl rounded-lg p-3 sm:p-6">
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        {(signupPage || editUserPage || loginPage) && (
          <>
            ...
            <div className="flex flex-col">
              ...
              />
              {userErrors.password && (
                <p className="errorInputs sm:text-md">{userErrors.password}</p>
              )}
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="flex flex-col">
              ...
              {userErrors.firstname && (
                <p className="errorInputs sm:text-md">{userErrors.firstname}</p>
              )}
            </div>
            <div className="flex flex-col">
              <label
              ...
              />
              {userErrors.lastname && (
                <p className="errorInputs sm:text-md">{userErrors.lastname}</p>
              )}
            </div>
            <div className="flex flex-col">
              <label
        ...
        <div className="text-center space-x-4">
          <button
            className="buttons bg-green-800 hover:bg-green-900"
            disabled={!isValid}
            type="submit"
          >
            {buttonType}
          ...
          {user && (
            <button
              ...
              className="buttons bg-red-800 hover:bg-red-900"
            >
              Delete Profile
            </button>
          )}
