...
const UserCard = ({
  ...
  return (
    <div>
      <Link to={`/user-page/${id}`} className="flex w-50 justify-center items-center shadow-lg flex-col m-3 rounded-lg hover:shadow-2xl transition transform duration-200 ease-in-out bg-gradient-to-t from-white to-transparent">
